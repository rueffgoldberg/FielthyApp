...
public class BalkeActivity extends AppCompatActivity implements OnMapReadyCallback {

    private TextView tV_time, tV_btn_track, hari, tanggal;
    private EditText eT_tahun, eT_beratbadan, eT_tinggibadan, eT_gender;
    private LinearLayout btn_track, btnPanduanBalke;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPanduanBalke.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void toggleTracking() {
        ...
        final long duration = TimeUnit.MINUTES.toMillis(15);
